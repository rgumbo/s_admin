...
class ClassMember(models.Model):
    ...
    cm_phone     = models.CharField(verbose_name='Phone', max_length=100,null=True, blank=True ,help_text='Contact phone')
    cm_email     = models.CharField(verbose_name='Email', max_length=100,null=True, blank=True, help_text='Contact Email')
    cm_dob       = models.DateTimeField(verbose_name='Date Of Birth', null=True, blank=True,help_text='Date of birth')
    cm_gender    = models.CharField(verbose_name='Gender', max_length=1, choices=gender_choice, default='F', help_text='Gender')
    cm_doj       = models.DateTimeField(verbose_name='Date joined', null=True, blank=True,help_text='Date Joined')
    cm_dol       = models.DateTimeField(verbose_name='Date of Leaving',null=True, blank=True, help_text='Date of leaving')
